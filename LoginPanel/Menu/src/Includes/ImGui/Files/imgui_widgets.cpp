...
bool ImGui::SliderScalar( const char * label, ImGuiDataType data_type, void * p_data, const void * p_min, const void * p_max, const char * format, ImGuiSliderFlags flags )
{
	...
	SliderAnim->second.BackGroundCol = ImLerp( SliderAnim->second.BackGroundCol, Hovered ? ImColor( 24, 24, 28 ) : ImColor( 18, 18, 21 ), g.IO.DeltaTime * 6.f );

	Window->DrawList->AddRectFilled( SliderRect.Min, SliderRect.Max, ImGui::GetColorU32( SliderAnim->second.BackGroundCol ), 12 );
	Window->DrawList->AddRect( SliderRect.Min, SliderRect.Max, ImGui::GetColorU32( ImVec4( ImColor( 35, 35, 40 ) ) ), 12 );
	Window->DrawList->AddRectFilled( ImVec2( SliderRect.Min.x, SliderRect.Min.y ), ImVec2( SliderRect.Min.x + SliderAnim->second.Slow, SliderRect.Max.y ), ImGui::GetColorU32( g_Col.Base ), 12 );
