...
namespace Custom {
    ...
    inline bool Button(const char* label, const ImVec2& size_arg = ImVec2(0, 0)) {
        ...
        // Render
        window->DrawList->AddRectFilled(bb.Min, bb.Max, bg_col, 6.f);
        window->DrawList->AddRect(bb.Min, bb.Max, border_col, 6.f);
    ...
    inline bool CheckBox(const char* label, bool* v) {
        ...
        // Render checkbox
        window->DrawList->AddRectFilled(check_bb.Min, check_bb.Max, GetColorU32(ImVec4(0.07f, 0.07f, 0.08f, 1.0f)), 4.f);
        window->DrawList->AddRect(check_bb.Min, check_bb.Max, GetColorU32(ImVec4(0.10f, 0.10f, 0.11f, 1.0f)), 4.f);
